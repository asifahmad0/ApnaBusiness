      ...
      <section className="overflow-hidden max-w-7xl mx-auto py-5 lg:py-20 px-6 grid md:grid-cols-2 lg:grid-cols-3 gap-10">
        {services.map((service, index) => (
          <div
            key={index}
            data-aos="fade-up"
            className="relative bg-bg3  rounded-2xl overflow-hidden 
            shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 hover:border hover:border-primery">
