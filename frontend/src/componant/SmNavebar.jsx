...
function SmNavebar() {
  ...
  return (
    <div className={`sm_nave bg-bg3 fixed z-[9999] w-screen h-[60px] flex lg:flex-row items-center justify-between  lg:px-17 shadow-lg  ${isOpen? "h-screen flex-col": "h-[50px] overflow-hidden"} `}>
